        ...
        return [
            ...
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'GET', 'path' => '/sync/files/download/{uuid}', 'summary' => 'Télécharger un fichier'],
                ],
            ],
            [
                'name' => 'dashboard',
            ...
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'PUT', 'path' => '/profile', 'summary' => 'Mettre à jour le profil'],
            ...
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'POST', 'path' => '/documents', 'summary' => 'Créer un document'],
                    ['method' => 'GET', 'path' => '/documents/{document}', 'summary' => 'Afficher un document'],
                    ['method' => 'PUT', 'path' => '/documents/{document}', 'summary' => 'Mettre à jour un document'],
                    ['method' => 'DELETE', 'path' => '/documents/{document}', 'summary' => 'Supprimer un document'],
                    ['method' => 'GET', 'path' => '/documents/{document}/download', 'summary' => 'Télécharger un document'],
                ],
            ],
            [
                'name' => 'requests',
                ...
                'operations' => [
                    ...
                    ['method' => 'POST', 'path' => '/requests', 'summary' => 'Créer une demande'],
                    ['method' => 'GET', 'path' => '/requests/{request}', 'summary' => 'Afficher une demande'],
                    ['method' => 'PUT', 'path' => '/requests/{request}', 'summary' => 'Mettre à jour une demande'],
            ...
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'POST', 'path' => '/agents', 'summary' => 'Créer un agent'],
                    ['method' => 'GET', 'path' => '/agents/{agent}', 'summary' => 'Afficher un agent'],
                    ['method' => 'PUT', 'path' => '/agents/{agent}', 'summary' => 'Mettre à jour un agent'],
            ...
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'POST', 'path' => '/pointages', 'summary' => 'Créer un pointage'],
                    ['method' => 'GET', 'path' => '/pointages/{pointage}', 'summary' => 'Afficher un pointage'],
                    ['method' => 'PUT', 'path' => '/pointages/{pointage}', 'summary' => 'Mettre à jour un pointage'],
            ...
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'POST', 'path' => '/signalements', 'summary' => 'Créer un signalement'],
                    ['method' => 'GET', 'path' => '/signalements/{signalement}', 'summary' => 'Afficher un signalement'],
                    ['method' => 'PUT', 'path' => '/signalements/{signalement}', 'summary' => 'Mettre à jour un signalement'],
            ...
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'POST', 'path' => '/communiques', 'summary' => 'Créer un communique'],
                    ['method' => 'GET', 'path' => '/communiques/{communique}', 'summary' => 'Afficher un communique'],
                    ['method' => 'PUT', 'path' => '/communiques/{communique}', 'summary' => 'Mettre à jour un communique'],
            ...
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'POST', 'path' => '/holidays', 'summary' => 'Créer un congé'],
                    ['method' => 'GET', 'path' => '/holidays/{holiday}', 'summary' => 'Afficher un conge'],
                    ['method' => 'PUT', 'path' => '/holidays/{holiday}', 'summary' => 'Mettre à jour un conge'],
                    ['method' => 'POST', 'path' => '/holidays/{holiday}/approve', 'summary' => 'Approuver un conge'],
                    ['method' => 'POST', 'path' => '/holidays/{holiday}/refuse', 'summary' => 'Refuser un congé'],
                ],
            ],
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'POST', 'path' => '/holiday-plannings', 'summary' => 'Créer un planning'],
                    ['method' => 'GET', 'path' => '/holiday-plannings/{holidayPlanning}', 'summary' => 'Afficher un planning'],
                    ['method' => 'PUT', 'path' => '/holiday-plannings/{holidayPlanning}', 'summary' => 'Mettre à jour un planning'],
            ...
            [
                ...
                'operations' => [
                    ...
                    ['method' => 'POST', 'path' => '/agent-statuses', 'summary' => 'Créer un statut'],
