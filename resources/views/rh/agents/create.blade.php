                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('provenance_matricule') is-invalid @enderror"
                                   ...
                                   value="{{ old('provenance_matricule') }}" placeholder="Ex: Fonction Publique, PNMLS...">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('grade_etat') is-invalid @enderror"
                                   id="grade_etat" name="grade_etat"
                                   value="{{ old('grade_etat') }}" placeholder="Ex: Attaché de bureau, Directeur...">
                            @error('grade_etat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
