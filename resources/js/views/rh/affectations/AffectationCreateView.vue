  ...
  <div class="container-fluid" style="max-width: 960px; padding-top: 2rem; padding-bottom: 3rem;">
    ...
    <div class="affectation-hero">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h2><i class="fas fa-plus-circle me-2"></i> Nouvelle Affectation</h2>
          <p>Affecter un agent a une fonction et une structure administrative.</p>
        </div>
...
async function submitForm() {
  ...
  try {
    ...
    if (err.response?.status === 422) {
      ...
      ui.addToast('Erreur lors de la creation de l\'affectation', 'danger')
    }
  } finally {
