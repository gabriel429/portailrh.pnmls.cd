        ...
        <div class="form-section">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-3">
              ...
              <input type="number" min="1950" max="2100" class="form-control" :class="{ 'is-invalid': errors.annee_naissance }" id="annee_naissance" v-model.number="form.annee_naissance" placeholder="1985" required>
