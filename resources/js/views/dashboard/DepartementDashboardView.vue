...
const taskBaseRoute = computed(() => '/taches?scope=departement')
...
const quickActions = computed(() => {
  const base = [
    { to: '/taches?create=1',                  icon: 'fa-plus-circle',    color: '#0077B5', bg: '#e0f2fe', label: 'Nouvelle tâche',       desc: 'Créer et attribuer une tâche' },
    ...
    { to: '/mailbox',                           icon: 'fa-envelope',       color: '#0284c7', bg: '#e0f2fe', label: 'Mail',                desc: 'Boîte de réception' },
...
const metrics = computed(() => {
  ...
  return [
    ...
    { label: "Demandes en attente",  icon: 'fa-hourglass-half',     color: '#7c3aed', bg: '#ede9fe',
      ...
      alert: (data.value?.requests?.en_attente ?? 0) > 3 },
